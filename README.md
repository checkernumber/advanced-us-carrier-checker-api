# Advanced US Carrier Checker API — official examples | CheckNumber

This repository documents the CheckNumber Advanced US Carrier Checker API integration contract using facts from the expansion manifest.

- Product page: https://checknumber.ai/products/advanced-us-carrier-checker
...
```bash
curl -X POST "https://api.checknumber.ai/v1/tasks" -H "X-API-Key: ${CHECKNUMBER_API_KEY}" -F "file=@examples/numbers.txt" -F "task_type=us_carrier_premium"
...
| --- | --- | --- | --- | --- | --- |
| `us_carrier_premium` | Advanced US Carrier Checker | phone | 2000–10000000 rows | `Number, number_type, carrier, city` | [docs](https://docs.checknumber.ai/advanced-us-carrier-checker) |
...
- `us_carrier_premium`: https://docs.checknumber.ai/advanced-us-carrier-checker
